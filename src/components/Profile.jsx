  ...
  return (
    ...
    >
      <div className=" text-white flex flex-col lg:gap-5 gap-3 px-4 pb-3 ">
        ...
        <p className="text-[40px] md:text-[50px] lg:text-[60px] font-bold tracking-wide">
          I'm Jayson Das K
        </p>
        <p className="text-[24px] md:text-[26px] lg:text-[28px] tracking-wider">
          Flutter Developer
        </p>
        <div className="w-full md:w-[500px] lg:w-[600px]">
          <p className="text-[15px] sm:text-[17px] tracking-wider">
            ...
            responsive applications on time, ensuring complete satisfaction and
            a seamless user experience.{" "}
          </p>
        </div>
        <button className="text-white bg-[#df4b22] hover:bg-[#d85430db] rounded-md py-2 px-3 w-[120px]">
          <a href="https://api.whatsapp.com/send?phone=918593834678">Hire Me</a>
        </button>
      </div>
      ...
      <div>
        <img
          src={photo}
          alt="Jayson Das - Flutter Developer"
          className="rounded-full md:w-[400px] w-[300px] h-[300px] md:h-[400px] object-cover border-2 border-dashed border-[#df4b22] transition-transform duration-300 hover:scale-105"
          loading="lazy"
          decoding="async"
        />
      </div>
