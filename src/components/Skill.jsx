...
export default function Skill() {
  ...
  return (
    <div
      id="skills"
      className="bg-[#333647] lg:h-screen w-full text-white  flex flex-col items-center justify-center overflow-hidden "
    >
      <div className="p-6 gap-3 md:pl-20 flex flex-col md:flex-row md:justify-center md:gap-56  md:items-center  ">
        ...
        <div
          className="lg:w-[500px] tracking-wider leading-relaxed"
          data-aos="fade-up"
        >
          <p>
            You should hire me for your project because I am a professional
            Flutter developer with 1.5 years of experience. I am committed to
            delivering high-quality, responsive applications on time, ensuring
            client satisfaction and a seamless user experience. I am eager to
        ...
        {progress.map((skill) => (
          ...
          >
            <img
              ...
              decoding="async"
            />
            <p className="mt-2 text-white text-lg font-semibold pb-4">
              {skill.title}
            </p>
          </div>
        ))}
